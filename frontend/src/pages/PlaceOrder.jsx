...
const PlaceOrder = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try{
      ...
      switch(method){
        // api calls for different payment methods 
        case 'cod':
    ...
    <div className='mt-8'>
      ...
      <div className='mt-12'>
        ...
        <div className='w-full text-end mt-8'>
          <button type='submit' className='bg-black border text-white px-16 py-3 text-sm hover:bg-gray-600 '>PLACE ORDER</button>
        </div>
